...
///   is set to 3. This function will output the edge
...
///   \n\b WARNING: must be multiple of 16 (8 * 2-bytes per gradient value).
///
/// @ingroup image_processing
//------------------------------------------------------------------------------
...
///
/// @param barrier
///  FAST threshold. The threshold is used to compare difference between intensity value of the central pixel and pixels on a circle 
...
///  scales if necessary. For any pixel set in the mask, the corresponding pixel in the image
///  will be ignored.
///   \n\b NOTE: must be 128-bit aligned.
///
/// @param maskWidth
...
///   column 0 of row 2 in the interleaved gradients array. If left at 0 gradStride is default to 4 * srcWidth.
///   \n\b WARNING: must be multiple of 8.
///
/// @ingroup image_processing
// -----------------------------------------------------------------------------
...
/// @param dxyStride
///   Stride (in bytes) of 'dx' and 'dy' gradient arrays.
///   \n\b WARNING: must be multiple of 8 (8 * 1-bytes per gradient value).
///
/// @ingroup image_processing
//------------------------------------------------------------------------------
...
///   column 0 of row 2).
///   \n\b WARNING: must be multiple of 32 (8 * 4-bytes).
///
///  @param dx
///   Buffer to store horizontal gradient. Must be (width)*(height) in size.
///   \n\b NOTE: a border of 1 pixel in size on top, bottom, left, and right
...
///   in scanline 0 and l0 is the right-most pixel coordinate
///   in scanline 0.
...
///
/// @param src
///   8-bit image where keypoints are detected
///   \n\b NOTE: data should be 128-bit aligned.
///
/// @param srcWidth
///   Image width
